// Staff Feedback View JavaScript
let allReviews = [];
...
function loadReviews() {
    ...
    allReviews = [
        ...
        {
            danhGiaId: 'A1B2C3D4-E5F6-7890-ABCD-EF1234567890',
            tourName: 'Tour Phú Quốc: Đảo Ngọc',
            customerName: 'Võ Thị G',
            sao: 5,
            tieuDe: 'Xuất sắc',
            noiDung: 'Phú Quốc đẹp tuyệt vời! Bãi biển trong xanh, đồ ăn hải sản tươi ngon. Dịch vụ 5 sao.',
            ngayDanhGia: '2024-01-18',
            trangThai: 'approved',
            bookingId: '12345678-1234-1234-1234-123456789012'
        },
        {
            danhGiaId: 'B2C3D4E5-F6A7-8901-BCDE-F23456789012',
            tourName: 'Tour Nha Trang: Thành phố Biển',
            customerName: 'Đỗ Văn H',
            sao: 4,
            tieuDe: 'Tốt',
            noiDung: 'Nha Trang đẹp, nhiều hoạt động thú vị. Hướng dẫn viên nhiệt tình.',
            ngayDanhGia: '2024-01-12',
            trangThai: 'approved',
            bookingId: '23456789-2345-2345-2345-234567890123'
        }
    ];
